# ...
# 
# Defina uma lista de canais (`youtuber`) e uma lista de visualizações (`visualizacoes`).
# 
# Imprima o número de visualizações de cada canal utilizando a lista `visualizacoes`.
# Adicione 2000 e 1500 visualizações para cada canal no mês 3.
